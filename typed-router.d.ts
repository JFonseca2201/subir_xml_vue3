...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'finances-operations-dashboard': RouteRecordInfo<'finances-operations-dashboard', '/finances/OperationsDashboard', Record<never, never>, Record<never, never>>,
    'finances-transaction-form': RouteRecordInfo<'finances-transaction-form', '/finances/TransactionForm', Record<never, never>, Record<never, never>>,
    'finances-transaction-list-page': RouteRecordInfo<'finances-transaction-list-page', '/finances/TransactionListPage', Record<never, never>, Record<never, never>>,
