    ...
    <VCard class="custom-dialog-card elevation-24">
      ...
      <div class="custom-dialog-header-primary">
        ...
        <div class="custom-dialog-avatar">
          <VIcon icon="ri-file-upload-line" />
        </div>
        <h3 class="custom-dialog-title">
          Importar Factura XML
        </h3>
        <p class="custom-dialog-subtitle">
          Carga comprobantes autorizados por el SRI
        </p>
      </div>
            ...
            >
              <thead>
                <tr>
                  ...
                  <th
                    class="text-left font-weight-bold py-2 border-b"
                    style="width: 150px;"
                  >
                    Código
                  </th>
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    <VCheckbox
                      v-model="item._selectedForInventory"
                      color="success"
                      density="compact"
                      hide-details
                      class="d-inline-flex mt-1"
                      @update:model-value="calculateTercerosFromUnchecked"
                    />
                  </td>
                  <td
                    class="text-truncate font-weight-bold text-caption"
                  ...
                  >
                    <VTooltip
                      v-if="item.descripcion && item.descripcion.length > 45"
                      location="top"
                      open-on-hover
                    >
            ...
            <VRow>
              ...
              >
                <VTextField
                  ...
                  type="number"
                  label="Total Asumido por Terceros"
                  prefix="$"
                  variant="outlined"
                  density="comfortable"
                  hint="Monto pagado por la otra compañía"
                  persistent-hint
                  :max="xmlTotals.total"
                  min="0"
                  step="0.01"
              ...
              >
                <VRow>
                  ...
                  >
                    <VCard
                      class="elevation-0 border bg-success-lighten-5"
                      :class="{ 'border-error': !isMathValid }"
                    >
      ...
      >
        <VAlert
          type="error"
          variant="tonal"
          class="rounded-xl border border-error bg-error-lighten-5 d-flex align-center"
          icon="ri-error-warning-fill"
          closable
          @click:close="error_exist = ''"
        >
