...
<template>
  ...
  >
    <VCard class="custom-dialog-card elevation-24">
      ...
      <VCardText
        class="pa-6 d-flex flex-column gap-4 bg-slate-50"
            ...
            <div v-if="paymentType === 'efectivo'">
              ...
              >
                <VSelect
                  ...
                  hide-details
                  style="flex: 1.5;"
                  @update:model-value="onPaymentMethodChange(dist, $event)"
                />
              ...
              <!-- Balance status bar -->
              <div
                class="mt-4 pa-3 rounded-lg border d-flex justify-space-between align-center"
              ...
              >
                ...
                <div>
                  ...
                  <span
                    ...
                    :class="isPaymentBalanced ? 'text-success' : 'text-error'"
                  >
      ...
      <!-- Footer -->
      <VCardActions
        class="d-flex justify-end align-center gap-3 px-6 pb-6 pt-3 bg-grey-lighten-4 border-t"
