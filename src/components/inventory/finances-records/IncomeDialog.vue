                ...
                <VForm @submit.prevent="saveIncome">
                    ...
                    <div class="pa-4">
                        <div class="d-flex justify-space-between align-center mb-3">
                            ...
                            <VBtn size="small" color="primary" @click="addPayment" :disabled="!canAddMorePayments">
                        ...
                        <div v-for="(payment, index) in (form.payments || [])" :key="index" class="mb-3">
                            <VCard variant="outlined" class="pa-3">
                                <VCardText class="pa-0">
                                    <VRow>
                                        <VCol cols="12" md="5">
                                            <VSelect v-model="payment.account_id" :items="accountOptions"
                                                item-title="title" item-value="value" label="Cuenta" required />
                                        </VCol>
                                        <VCol cols="12" md="5">
                                            <VTextField v-model="payment.amount" label="Monto" type="number" prefix="$"
                                                placeholder="0.00" required />
                                        </VCol>
                                        <VCol cols="12" md="2">
                                            <VBtn color="error" variant="outlined" @click="removePayment(index)"
                    ...
                    <VCardActions class="pa-4 justify-end">
                        ...
                        <VBtn color="success" @click="saveIncome" :disabled="totalToRegister <= 0">
