    ...
    <VDialog v-model="show" max-width="500" persistent>
        <VCard>
                    ...
                    <VRow>
                        ...
                        <VCol cols="12">
                            <VSelect v-model="form.partner_id" :items="partners" item-title="name" item-value="id"
                                label="Socio *" placeholder="Selecciona un socio"
                                :rules="[v => !!v || 'El socio es requerido']" variant="outlined" density="comfortable">
                                <template #prepend-inner>
                                    <VIcon color="primary" size="20">ri-group-line</VIcon>
                                </template>
                            </VSelect>
                        </VCol>
                        ...
                        <!-- Monto -->
                        <VCol cols="12">
                            <VTextField v-model="form.monto" label="Monto *" placeholder="0.00" type="number"
                                step="0.01" min="0.01" :rules="[
                        ...
                        <!-- Cuenta -->
                        <VCol cols="6">
                            <VSelect v-model="form.cuenta_id" :items="accounts" item-title="name" item-value="id"
                                label="Cuenta *" placeholder="Selecciona una cuenta"
                        ...
                        <!-- Método de Pago -->
                        <VCol cols="12" md="6">
                            <VSelect v-model="form.metodo_pago" :items="metodosPago" item-title="text"
                        ...
                        <!-- Fecha -->
                        <VCol cols="12" md="6">
                            <VTextField v-model="form.fecha_aporte" label="Fecha *" type="date"
                        ...
                        <!-- Hora -->
                        <VCol cols="12" md="6">
                            <VTextField v-model="form.hora_aporte" label="Hora *" type="time"
                                :rules="[v => !!v || 'La hora es requerida']" variant="outlined" density="comfortable">
                                <template #prepend-inner>
                                    <VIcon color="primary" size="20">ri-time-line</VIcon>
                                </template>
                            </VTextField>
                        </VCol>
                        ...
                        <!-- Descripción -->
                        <VCol cols="12">
                            <VTextarea v-model="form.descripcion" label="Descripción"
                                placeholder="Describe el aporte de capital..." rows="3" variant="outlined"
                                density="comfortable" no-resize>
                                <template #prepend-inner>
            ...
            <VCardActions class="pa-6">
                <VSpacer />
                <VBtn variant="outlined" @click="closeDialog" :disabled="loading" prepend-icon="ri-close-line">
                    Cancelar
                </VBtn>
                <VBtn color="primary" variant="elevated" @click="handleSubmit" :loading="loading"
...
:deep(.v-field--focused) {
    box-shadow: 0 4px 20px rgba(240, 147, 251, 0.15) !important;
