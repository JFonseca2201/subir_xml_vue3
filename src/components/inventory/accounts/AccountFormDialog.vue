          ...
          <VRow>
            ...
            >
              <VTextField
                ...
                placeholder="Ej: BAN-001"
                prepend-inner-icon="ri-hashtag"
                variant="outlined"
                density="comfortable"
                :rules="rules.code"
                :disabled="isSystemAccount"
                hint="Código único para identificar la cuenta"
                persistent-hint
                @blur="transformToUppercase('code')"
              >
                <template
            ...
            >
              <VTextField
                ...
                persistent-hint
                @blur="transformToUppercase('name')"
              />
            </VCol>
            ...
            >
              <VTextField
                ...
                persistent-hint
                @blur="transformToUppercase('bank_name')"
              />
            </VCol>
            ...
            <VCol
              v-if="isEditing && isSystemAccount"
              cols="12"
            >
              <VAlert
                type="warning"
