...
const loadAvailableAccounts = async () => {
    ...
    try {
        ...
        console.log('Raw API response from transfer-accounts (AddDialog):', resp)
...
const handleSubmit = async () => {
    ...
    try {
        ...
        console.log('from_account_id:', requestBody.from_account_id)
        console.log('to_account_id:', requestBody.to_account_id)
