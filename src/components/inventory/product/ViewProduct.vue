    ...
    <VCard class="custom-dialog-card product-view-card">
      ...
      >
        ...
        <div class="d-flex flex-column flex-sm-row align-center align-sm-start gap-6 mb-6 bg-white pa-4 rounded-lg elevation-1">
          <div
            class="cursor-pointer image-container position-relative rounded-lg overflow-hidden border" 
            style="width: 140px; height: 140px; flex-shrink: 0;"
          ...
          >
            ...
            <div
              v-else
              class="d-flex align-center justify-center w-100 h-100 bg-grey-lighten-4"
            >
              <VIcon
                icon="ri-image-line"
                size="48"
            ...
            <div
              class="image-overlay position-absolute top-0 left-0 w-100 h-100 d-flex flex-column align-center justify-center bg-black"
        ...
        <VRow class="mb-6">
          <!-- Precio Compra -->
          <VCol
            v-if="product.item_type == 1"
            cols="12"
            sm="6"
          >
            <VCard
              variant="outlined"
              class="bg-white border text-center h-100 pa-4"
          ...
          <VCol
            cols="12"
            :sm="product.item_type == 1 ? 6 : 12"
          >
            <VCard
              variant="outlined"
              class="bg-success-lighten-5 text-center h-100 pa-4"
              style="border-color: #81C784 !important;"
            >
              <div class="text-overline text-success font-weight-bold mb-2">
              ...
              <div class="d-flex justify-center align-center">
                <div class="px-4">
                  ...
                  <div class="text-h6 text-success">
                    ${{ Number(product.price_sale || 0).toFixed(2) }}
                  </div>
                </div>
                <VDivider
                  vertical
          ...
          <!-- Descuento (Si aplica) -->
          <VCol
            v-if="product.max_discount > 0 || product.discount_percentage > 0"
            cols="12"
          >
            <VCard
              variant="outlined"
              class="bg-error-lighten-5 border-error border-opacity-25 pa-3 d-flex align-center justify-center gap-4"
            >
        ...
        <VRow>
          ...
          >
            <VCard
              variant="flat"
              class="bg-white rounded-lg elevation-1 h-100"
            >
              ...
              <VCardText class="pa-4">
                <div class="d-flex align-center justify-space-between mb-4 bg-grey-lighten-4 pa-3 rounded">
                  ...
                  <span
                    ...
                    :class="getStockClassText(product.stock, product.min_stock)"
                  >
                    {{ product.stock || 0 }}
                  </span>
                </div>
                ...
                >
                  ...
                  <VListItem class="px-0">
                    ...
                    <div class="text-body-2 font-weight-medium text-right">
                      {{ product.warehouse?.name || 'General' }}
                    </div>
                  </VListItem>
                </VList>
              </VCardText>
        ...
        >
          <VCol cols="12">
            ...
            >
              <VCardTitle class="text-subtitle-2 font-weight-bold border-b py-2">
                Notas Adicionales
              </VCardTitle>
              <VCardText
      ...
      <VCardActions
        class="pa-4 bg-grey-lighten-4 border-t d-flex justify-end align-center gap-3"
