        ...
        <VCard>
            ...
            <VCardTitle class="pa-6 pb-4">
                ...
                <div class="d-flex align-center gap-3">
                    <VIcon icon="ri-add-circle-line" color="info" size="28" />
                    <div>
                        <h3 class="text-h5 font-weight-bold">Nuevo Adelanto</h3>
                ...
                <VForm ref="formRef" @submit.prevent="handleSubmit">
                    <VCardText>
                        <VRow>
                            ...
                            <VCol cols="12">
                                <VTextField v-model="form.amount" label="Monto" type="number" prefix="$"
                                    placeholder="0.00" :rules="[v => !!v && v > 0]" required />
                            </VCol>
                    ...
                    <VCardActions class="pa-6 d-flex justify-end">
                        ...
                        <VBtn color="default" prepend-icon="ri-close-line" variant="outlined" @click="closeDialog">
                            Cancelar
                        </VBtn>
                        <VBtn color="primary" type="submit"
                            :style="{ '--color': 'var(--vscode-editor-foreground) !important' }"
                            prepend-icon="ri-save-line" :loading="loading" :disabled="loading">
                            Crear Adelanto
                        </VBtn>
                    </VCardActions>
                </VForm>
