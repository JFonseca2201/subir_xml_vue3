...
<template>
  ...
  >
    <VCard
      ...
      class="custom-dialog-card overflow-hidden relative"
    >
          ...
          >
            ...
            >
              ...
              <div class="mb-3">
                ...
                <div
                  class="text-body-1 text-high-emphasis bg-light pa-3 rounded-lg text-pre-wrap"
              ...
              <div class="d-flex justify-end gap-6 pt-2 border-t mt-2 align-center">
                ...
                <div class="text-right pl-4 border-l">
                  ...
                  <div
                    ...
                    style="font-family: 'Consolas', 'Monaco', 'Courier New', monospace !important; opacity: 0.8;"
                  >
