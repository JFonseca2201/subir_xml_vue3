...
<template>
  <div>
    ...
    <VCard
      elevation="8"
      class="pa-8 rounded-xl border-thin max-w-4xl mx-auto"
    >
      <!-- Header -->
      ...
      >
        <VRow>
          ...
          >
            <VTextField
              v-model="sucursal.serie_factura"
              label="Serie Factura"
              variant="outlined"
              density="comfortable"
          ...
          >
            <VTextField
              v-model="sucursal.secuencial_factura"
              label="Secuencial"
              variant="outlined"
              density="comfortable"
          ...
          >
            <VTextField
              v-model="sucursal.establecimiento"
          ...
          >
            <VTextField
              v-model="sucursal.punto_emision"
              label="Punto Emisión"
              variant="outlined"
              density="comfortable"
          ...
          >
            <VSelect
              ...
              variant="outlined"
              density="comfortable"
              prepend-inner-icon="ri-cloud-line"
              hide-details="auto"
              :disabled="!isEditing"
            />
          </VCol>
          ...
          >
            <VSelect
              v-model="sucursal.obligado_contabilidad"
              :items="[
                { title: 'Sí', value: 'SI' },
                { title: 'No', value: 'NO' }
              ]"
          ...
          >
            <VTextField
              v-model="sucursal.contribuyente_especial"
