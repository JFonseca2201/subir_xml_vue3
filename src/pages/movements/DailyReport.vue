...
<template>
    <div>
        ...
        <div class="d-flex justify-space-between align-center mb-6">
            <div>
                <h2 class="text-h4 font-weight-bold">Reporte Diario</h2>
                <p class="text-medium-emphasis mb-0">Resumen de movimientos por día</p>
            </div>
            <div class="d-flex gap-3">
                <VBtn color="primary" prepend-icon="ri-refresh-line" @click="loadReport" :loading="loading">
                    Actualizar
                </VBtn>
                <VBtn color="success" prepend-icon="ri-file-download-line" @click="generateReport">
                    Generar Reporte
                </VBtn>
            </div>
        </div>
        ...
        <VCard class="rounded-lg elevation-4">
            ...
            <VCardText class="pa-0">
                ...
                <div v-if="loading" class="d-flex justify-center pa-12">
                    ...
                    <p class="text-medium-emphasis mt-3">Cargando reporte...</p>
                </div>

                <!-- Tabla de Datos -->
                <VTable v-else class="report-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr v-for="item in reportData" :key="item.entry_date">
