            ...
            <tbody v-else>
              ...
              >
                ...
                <td class="text-left py-3">
                  ...
                  >
                    <VChip
                      v-for="(permission, index) in item.permissions_pluck.slice(0, 4)"
                      :key="index"
                    ...
                    <VChip
                      v-if="item.permissions_pluck.length > 4"
                      variant="tonal"
                      size="small"
                      color="secondary"
                    ...
                    >
                      ...
                      >
                        <div class="pa-2">
                          <div
                            class="text-subtitle-2 font-weight-bold mb-2 pb-1"
                          ...
                          <div class="d-flex flex-wrap gap-1">
                            <VChip
                              v-for="(permission, index) in item.permissions_pluck.slice(4)"
                              :key="index"
                              :color="permissionColor(typeof permission === 'object' ? permission.name : permission)"
                              variant="flat"
                              size="x-small"
