...
<template>
  <div class="pa-4 pa-sm-6 position-relative">
    ...
    <VCard class="rounded-lg elevation-2 max-w-1200 mx-auto overflow-hidden">
      ...
      <div v-if="isLoading" class="pa-6 pb-12 d-flex flex-column gap-6">
        <div class="mb-8">
            ...
            <VRow>
              ...
              <VCol cols="12" md="6" v-if="product.item_type !== '2'">
                <VCard variant="outlined" class="pa-4 h-100 rounded-lg">
                  ...
                  <VRow>
                    <VCol cols="12">
                      <VTextField v-model="product.stock" :rules="stockRules" label="Stock Inicial Actual"
                        placeholder="0" variant="outlined" density="comfortable" prepend-inner-icon="ri-stack-line"
