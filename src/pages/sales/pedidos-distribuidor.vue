      ...
      <div>
        <div class="d-flex align-center">
          ...
          <div>
            ...
            <p class="text-medium-emphasis mb-0">Solicitud de productos a proveedor (sin impacto en inventario ni caja)</p>
          </div>
        </div>
      </div>
                ...
                >
                  ...
                  <template #no-data>
                    <div class="pa-4 text-center text-medium-emphasis">
                      ...
                      {{ pedido.distribuidor_id ? 'No se encontraron productos para este distribuidor' : 'Seleccione un distribuidor primero' }}
                    </div>
                  </template>
                </VAutocomplete>
                ...
                <div class="mt-6 pa-3 bg-blue-lighten-5 rounded-lg border border-blue-lighten-4">
                  <div class="d-flex align-start gap-2">
                    ...
                    <div class="text-caption text-info-darken-3">
                      ...
                      Este pedido se registrará en estado <strong>Pendiente</strong>. No afecta el stock actual ni genera facturación financiera.
                    </div>
                  </div>
                </div>
              </VCardText>
